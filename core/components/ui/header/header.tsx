...
const Header = ({
  ...
  <div className={cn('relative', className)}>
    <header className="flex h-[92px] items-center justify-between gap-1 overflow-y-visible px-4 2xl:container sm:px-10 lg:gap-8 lg:px-12 2xl:mx-auto 2xl:px-0">
      ...
      <NavigationMenuPrimitive.Root className="hidden lg:block">
        ...
        <NavigationMenuPrimitive.Viewport className="absolute start-0 top-full z-50 w-full bg-bcgray pb-12 pt-6 shadow-xl duration-200 animate-in slide-in-from-top-5" />
